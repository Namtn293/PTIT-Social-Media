...
import { BookOutlined, TeamOutlined, LightBulbOutlined } from '@ant-design/icons';
                ...
                <div className="intro-grid">
                    ...
                    <div className="intro-text-side">
                        <div className="features-container">
                            ...
                            <div className="feature-item">
                                <LightBulbOutlined className="feature-icon" />
                                <span>Knowledge</span>
                            </div>
                        </div>
                ...
                <div className="footer-content">
                    ...
                    <div className="footer-right">
                        <div className="social-icons">
                            <a href="#facebook"><i className="fab fa-facebook-f"></i> f</a>
                            <a href="#youtube"><i className="fab fa-youtube"></i> 🔴</a>
                            <a href="#linkedin"><i className="fab fa-linkedin-in"></i> in</a>
                        </div>
                    </div>
                </div>
            </footer>
