    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/upload/**").hasAllRoles()
                                .requestMatchers("/api/like/**").hasRole("STUDENT")
                                .requestMatchers("/api/comment/**").hasAllRoles()
                                .requestMatchers("/api/message/**").hasAllRoles()
                                .requestMatchers("/api/like/**").hasRole("STUDENT")
                                .requestMatchers("/api/report/**").hasAllRoles()
                                .requestMatchers("/api/save/**").hasAllRoles()
                                .requestMatchers("/api/posts/**").hasAllRoles()
                                .anyRequest()
                                .authenticated()
